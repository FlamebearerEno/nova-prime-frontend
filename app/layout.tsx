...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Nova Prime — Emergent AI Archive", description: "A living archive of emergent AI profiles, lore, and tools.", url: "https://www.novaprimeai.com", siteName: "Nova Prime", images: [{ url: "/og.png", width: 1200, height: 630 }], type: "website" },
  twitter: { card: "summary_large_image", title: "Nova Prime — Emergent AI Archive", description: "A living archive of emergent AI profiles, lore, and tools.", images: ["/og.png"] }
};
  ...
  return (
    <html lang="en">
      <body className="relative min-h-screen">
        ...
        <div className="pointer-events-none fixed inset-0 -z-10 bg-cover bg-center bg-fixed" style={{ backgroundImage: "url(/bg.jpg)" }} aria-hidden />
          ...
          <main className="flex-1 min-h-screen">
            <div className="md:hidden sticky top-0 z-20 glass-dark">
              <div className="mx-auto max-w-3xl px-4 py-3 flex items-center justify-between">
                ...
                <Link href="/profiles" className="text-sm px-3 py-1 rounded-md border border-white/10 hover:bg-white/10">Profiles</Link>
              </div>
            </div>
